...
public class ElementAddCommand extends SubCommand {
    ...
    @Configure String noOthers = "You don't have permission to add elements to others.";
    ...
    @Configure String noParents = "You don't have any of the parent elements required for that subelement.";
    @Configure String success = "The {element} element has been added to you.";

    public ElementAddCommand() {
        super("add", "Add an element to a user", "/elemengine add <element> [user]", Arrays.asList("a"));
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        if (element == null) {
            ...
            if (!hasParent) {
                sender.sendMessage(ChatColor.RED + noParents);
                return;
            }
        }
    ...
    public TabComplete tabComplete(CommandSender sender, String[] args) {
        if (args.length == 1) {
            return TabComplete.elements(false);
