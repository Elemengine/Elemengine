...
public class EarthbendingInfo implements SkillInfo {
    ...
    public String getDescription() {
        return "Earthbending is the ability to control the ground and rocks. Earth is the element of substance, enduring attacks until they have an opportunity to counterattack.";
    }
