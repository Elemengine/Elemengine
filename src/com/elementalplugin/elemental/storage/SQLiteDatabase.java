...
public class SQLiteDatabase implements Database {
    ...
    public Connection connect() {
        ...
        try {
            ...
            Elemental.plugin().getLogger().info("Database connected!");

            return connection;
        } catch (final ClassNotFoundException e) {
            Elemental.plugin().getLogger().warning("JDBC driver not found!");
            return null;
        } catch (final SQLException e) {
            Elemental.plugin().getLogger().warning("SQLite exception during connection.");
            return null;
        }
    }
