...
public class HelpCommand extends SubCommand {
    ...
    public HelpCommand() {
        super("help", "Get information on various topics", "/elemental help <topic>", Arrays.asList("h", "info"));
    }
    ...
    private BaseComponent[] ability(String arg, CommandSender sender) {
        ...
        if (!sender.hasPermission("elemental.ability." + abil.getName())) {
    ...
    private BaseComponent[] command(String arg, CommandSender sender) {
        ...
        ComponentBuilder msgs = new ComponentBuilder(cmd.getName()).color(ChatColor.DARK_AQUA).bold(true).append("\n" + cmd.getDescription(), FormatRetention.NONE).color(ChatColor.WHITE).append("\nHow to use: ").color(ChatColor.DARK_AQUA)
                .append(cmd.getUsage(), FormatRetention.NONE).color(ChatColor.WHITE).append("\nAliases: [").color(ChatColor.DARK_AQUA);
